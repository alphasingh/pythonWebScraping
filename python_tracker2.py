...
#        url = "https://www.amazon.in/Airtel-4G-Hotspot-E5573Cs-609-Portable/dp/B06WV9WR4Z"
        url = "https://www.amazon.in/Kindle-10th-Gen-Black-with-front-light/dp/B07FRJTZ4T/ref=sr_1_1?keywords=kindle&qid=1576411211&sr=8-1"
        ...
        # convert to integer 
        # since str is of format '₹\xa02272.00' we need to trace only number
        str = str.replace(", ", "");str=str.replace(",","")
        str = re.findall(r"(\d+)\.", str)[0]
        current_price = int(float(str));print(current_price)
        your_price = 2300
        if current_price < your_price : 
                print("Price decreased book now");print('\a')
